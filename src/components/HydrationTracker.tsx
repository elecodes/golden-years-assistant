...
export const HydrationTracker: React.FC = () => {
  ...
  return (
    <div className="card-action flex flex-col items-center gap-6">
      ...
      <div className="relative w-48 h-64 border-4 border-primary-blue rounded-b-3xl overflow-hidden bg-slate-50">
        <div 
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-5xl font-black text-slate-800 drop-shadow-md">
            {waterGlasses}/8
          </span>
        </div>
      </div>
      ...
      <div className="flex gap-4 w-full">
        <button
          ...
          className="btn-primary flex-1 flex items-center gap-3 justify-center"
        >
        ...
        <button
          onClick={handleReset}
          className="bg-slate-200 text-slate-700 rounded-xl p-4"
